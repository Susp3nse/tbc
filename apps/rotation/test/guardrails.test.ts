...
{
  const caster = read('src/tbc/aio/druid/caster.lua');
...
{
  const main = read('src/tbc/aio/main.lua');
...
{
  const core = read('src/tbc/aio/core.lua');
...
{
  const healing = read('src/tbc/aio/druid/healing.lua');
