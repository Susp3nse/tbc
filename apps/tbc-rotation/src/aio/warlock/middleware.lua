...
if not NS then
    print("|cFFFF0000[Menagerie Warlock Middleware]|r Core module not loaded!")
    return
end
...
NS.register_recovery_middleware({
    ...
    healthstone = {
        hp_default = 35,
        actions = { A.HealthstoneFel, A.HealthstoneMaster, A.HealthstoneMajor },
    },
    healing_potion = {
        hp_default = 25,
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Menagerie Warlock]|r Middleware module loaded")
