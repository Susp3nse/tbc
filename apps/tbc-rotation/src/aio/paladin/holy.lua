...
if not NS then
    print("|cFFFF0000[Menagerie Holy]|r Core module not loaded!")
    return
end

if not NS.rotation_registry then
    print("|cFFFF0000[Menagerie Holy]|r Registry not found!")
    return
end
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Menagerie Paladin]|r Holy module loaded")
