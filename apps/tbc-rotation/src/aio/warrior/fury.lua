...
if not NS then
    print("|cFFFF0000[Menagerie Fury]|r Core module not loaded!")
    return
end

if not NS.rotation_registry then
    print("|cFFFF0000[Menagerie Fury]|r Registry not found!")
    return
end
...
local Fury_SunderAura = { ID = Constants.DEBUFF_ID.SUNDER_ARMOR }
local Fury_SunderMaintain = NS.maintain_aura({
    name = "SunderMaintain",
    log_prefix = "[FURY]",
    requires_combat = true,
    requires_enemy = true,
    spell = A.SunderArmor,
    track_spell = Fury_SunderAura,
    kind = "debuff",
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Menagerie Warrior]|r Fury module loaded")
