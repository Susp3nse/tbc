...
if not NS then
    print("|cFFFF0000[Menagerie Arms]|r Core module not loaded!")
    return
end

if not NS.rotation_registry then
    print("|cFFFF0000[Menagerie Arms]|r Registry not found!")
    return
end
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Menagerie Warrior]|r Arms module loaded")
