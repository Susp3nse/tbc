...
if not NS then
    print("|cFFFF0000[Menagerie Subtlety]|r Core module not loaded!")
    return
end

if not NS.rotation_registry then
    print("|cFFFF0000[Menagerie Subtlety]|r Registry not found!")
    return
end
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Menagerie Rogue]|r Subtlety strategies registered (10 strategies)")
