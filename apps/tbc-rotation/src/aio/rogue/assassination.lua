...
if not NS then
    print("|cFFFF0000[Menagerie Assassination]|r Core module not loaded!")
    return
end

if not NS.rotation_registry then
    print("|cFFFF0000[Menagerie Assassination]|r Registry not found!")
    return
end
...
-- MODULE LOADED
-- ============================================================================
print("|cFF00FF00[Menagerie Rogue]|r Assassination strategies registered (10 strategies)")
